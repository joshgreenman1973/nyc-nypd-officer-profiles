...
| Dataset | ID | Rows | Role in this site |
|---|---|---|---|
| Allegations Against Police Officers | `6xgr-kwjq` | 433,285 | Complaint counts per officer; the FADO and disposition charts; per-officer detail (fetched live) |
| Police Officers | `2fir-qns4` | 98,293 | The name-and-shield match to the NYPD roster |
| Complaints Against Police Officers | `2mby-ccnw` | 141,860 | Incident date, precinct and body-camera evidence |
...
- **`ccrb.json`** — per-officer complaint counts for the 18,842
...
- **An allegation is an account, not a finding.** 433,285 allegations are on
...
- **Only serving officers appear.** The complaint tables cover
  ...
  18,842 who are still on today's roster, so an officer who
...
- **The complaint map is by place, not by roster.** Allegations are counted where the incident
  occurred. 9,093 allegations carry no precinct and are left
