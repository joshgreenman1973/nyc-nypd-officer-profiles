...
| Dataset | ID | Rows | Role in this site |
|---|---|---|---|
| Allegations Against Police Officers | `6xgr-kwjq` | 432,794 | Complaint counts per officer; the FADO and disposition charts; per-officer detail (fetched live) |
| Police Officers | `2fir-qns4` | 98,293 | The name-and-shield match to the NYPD roster |
| Complaints Against Police Officers | `2mby-ccnw` | 141,781 | Incident date, precinct and body-camera evidence |
| Penalties | `keep-pkmh` | 15,213 | What the NYPD did after the board substantiated |
...
- **`ccrb.json`** — per-officer complaint counts for the 18,876
...
- **An allegation is an account, not a finding.** 432,794 allegations are on
  file; 26,609 (6.1%) were substantiated by
...
- **Substantiated is not punished.** The board investigates; the NYPD decides the penalty and
  reports it back. Across 15,213 referrals, the most common single outcome
...
- **Only serving officers appear.** The complaint tables cover
  ...
  18,876 who are still on today's roster, so an officer who
...
- **The complaint map is by place, not by roster.** Allegations are counted where the incident
  occurred. 9,080 allegations carry no precinct and are left
