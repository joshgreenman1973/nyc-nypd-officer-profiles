...
**This file is generated by `build.py` from the 2026-07-26 export — do not edit by hand.**
...
|---|---|---|---|
| Members of Service (roster) | `pmsy-ewrc` | 33,945 | The officer list; all headline stats |
| Title / Shield History | `sh6y-4tgb` | 53,887 | Per-officer career timeline (fetched live) |
| Training | `n3mp-t5uj` | 12,721,262 | Aggregate training chart only |
| Department Recognition | `i9n8-a8ed` | 141,969 | Awards chart; "the decorated" |
| Disciplinary History — Summary | `wq9a-qu9a` | 1,528 | Recomputed here from the charges table |
| Disciplinary History — Charges | `uafj-ik29` | 3,895 | Discipline view; per-officer discipline |
...
- **`roster.json`** — all 33,945 officers as a compact columnar array. A
  per-officer count of sustained charges and a parsed precinct number are added.
- **`discipline.json`** — all 3,895 charges, each joined to the
...
- **Discipline is guilty findings only.** All 3,895 published
  charges carry a disposition of guilty, pleaded guilty or no contest
  (2,638 / 1,236 / 21 — which sum to 3,895). Dismissed,
...
- **The precinct map covers patrol precincts only.** Commands were mapped to a precinct by
  ...
  name because its command carries no number. About 14,285 of
  33,945 officers sit in a patrol precinct; the rest (housing, transit,
...
- **Awards given vs officers who hold them.** A single officer can receive the same award
  ...
  Police Duty, for example, is awarded 91,834 times but to 16,484
  distinct officers (about 5.6 each); Meritorious Police Duty 46,905 times to
  10,698 officers. The awards table shows both columns. The six top medals are
  almost exactly one per officer.
- **Two ways to count recognitions.** The awards table and the "recognitions awarded"
  headline (141,969) count individual award records in
  `i9n8-a8ed`. The roster also carries a per-officer recognition counter
  (`department_recognitions`) that sums to 145,132 — slightly
...
33,945 needs context before it is cited:

- **Recruits are in the count.** 1,104 officers are in the `RTS RECRUITS`
...
- **So are officers who aren't working.** 797 sit at the
  ...
  32,044 than 33,945.
- **Domestic-violence officers moved out of patrol.** About 471 officers
  hold domestic-violence assignments, 428 of them in
...
- **Patrol strength is not a precinct's full footprint.** The precinct map counts patrol
  and field-training commands (14,285 officers). Another
  ~1,445 work in precinct-based detective and domestic-violence
